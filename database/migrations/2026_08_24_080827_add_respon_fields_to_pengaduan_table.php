...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('pengaduan', function (Blueprint $table) {
            $table->text('respon_admin')->nullable()->after('aduan');
            $table->timestamp('tgl_respon')->nullable()->after('respon_admin');
            $table->text('catatan_internal')->nullable()->after('tgl_respon');
            $table->string('lampiran')->nullable()->after('catatan_internal');
